...
public class SceneMan : MonoBehaviour
{
    ...
    public IEnumerator PushScene(enumSceneName enumSceneName, LoadSceneMode loadSceneMode, Action onDone = null)
    {
        AsyncOperation asyncOperation = SceneManager.LoadSceneAsync(enumSceneName.ToString(), loadSceneMode);
    ...
    /// <param name="onDonee">로드가 끝나면 추가적으로 실행할 메소드</param>
    public IEnumerator PopScene(Action onDone = null)
    {
